...
- Temporada: controles (Auto/Avançar) presos na base da janela (lista rola por trás); abas de
  Slams já disputados/em andamento são clicáveis para rever resultados, futuros não
  (decisão do Leco, 12/06/2026).
